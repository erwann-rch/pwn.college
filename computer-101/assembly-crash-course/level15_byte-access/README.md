# Level Description
```
hacker@assembly-crash-course~byte-access:~/asm_courses$ /challenge/run byte-access.elf 
...
# Solution
```
python byte-access.py
```
OR 

```
as byte-access.s -o byte-access.o; ld byte-access.o -o byte-access.elf; /challenge/run byte-access.elf
```
