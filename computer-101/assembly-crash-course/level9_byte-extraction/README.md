# Level Description
```
hacker@assembly-crash-course~byte-extraction:~/asm_courses$ /challenge/run byte-extraction.elf 
...
# Solution
```
python byte-extraction.py
```
OR 

```
as byte-extraction.s -o byte-extraction.o; ld byte-extraction.o -o byte-extraction.elf; /challenge/run byte-extraction.elf
```

# Flag
`pwn.college{Qcq3PAQgbaR776QH9lgIE4yNi2v.0FMwIDL5YTNzEzW}`
